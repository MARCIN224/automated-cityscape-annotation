...
Download the model file from the official source:
[sam_vit_h_4b8939.pth] : https://huggingface.co/HCMUE-Research/SAM-vit-h/blob/main/sam_vit_h_4b8939.pth

After downloading the SAM model file, place both the Python script (.py file) and the downloaded model file (.pth file) in the same folder.
